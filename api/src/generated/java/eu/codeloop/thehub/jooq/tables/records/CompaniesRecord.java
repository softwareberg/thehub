...
public class CompaniesRecord extends UpdatableRecordImpl<CompaniesRecord> implements Record6<String, String, String, String, OffsetDateTime, OffsetDateTime> {

    private static final long serialVersionUID = -1504764270;
     ...
     */
    @Override
    public Row6<String, String, String, String, OffsetDateTime, OffsetDateTime> fieldsRow() {
     ...
     */
    @Override
    public Row6<String, String, String, String, OffsetDateTime, OffsetDateTime> valuesRow() {
     ...
     */
    @Override
    public CompaniesRecord value5(OffsetDateTime value) {
     ...
     */
    @Override
    public CompaniesRecord values(String value1, String value2, String value3, String value4, OffsetDateTime value5, OffsetDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CompaniesRecord(String companyId, String name, String logo, String location, OffsetDateTime dateCreated, OffsetDateTime dateModified) {
        super(Companies.COMPANIES);
