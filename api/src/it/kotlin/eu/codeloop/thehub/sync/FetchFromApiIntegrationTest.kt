...
class FetchFromApiIntegrationTest : IntegrationTest() {
    ...
    fun `it should fetch jobs from external api and return sorted list`() {
        ...
        jobsResult
            ...
            .andExpect(jsonPath("$.data[0].description", containsString("heroes")))
            ...
            .andExpect(jsonPath("$.data[1].description", containsString("heroes")))
